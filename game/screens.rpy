...
screen navigation():
    add "images/careers.jpg" xalign 1.0 xysize (1500,1150)
    ...
    vbox:
        ...
        textbutton _("Careers") action ShowMenu("sector_selection") style "navigation_button"
        ...
        vbox:
            ...
            if selected_sector:
                ...
                if sectors[selected_sector]:
                    vbox:
                        spacing 40
                        text "[selected_sector] Careers" size 40 color "#0000ff" xalign 0.5
                        hbox:
                            spacing 40
            ...
            hbox:
                spacing 500
                textbutton "Back" action Return() style "my_textbutton"
                textbutton "Continue" action Return(selected_sector) style "my_textbutton"
